//
//  VdotokStreamingModule+RTCPeerConnection.m
//
...
#import "VdotokStreamingModule+RTCDataChannel.h"
#import "VdotokStreamingModule+RTCPeerConnection.h"
#import "VdotokStreamingModule+VideoTrackAdapter.h"
...
- (id)vdotokStreamingModule
{
    return objc_getAssociatedObject(self, _cmd);
}

- (void)setVdotokStreamingModule:(id)vdotokStreamingModule
{
    objc_setAssociatedObject(self, @selector(vdotokStreamingModule), vdotokStreamingModule, OBJC_ASSOCIATION_ASSIGN);
}

@end

@implementation VdotokStreamingModule (RTCPeerConnection)
                                                 ...
                                                 objectID:(nonnull NSNumber *)objectID)
{
    dispatch_sync(self.workerQueue, ^{
        ...
        RTCMediaConstraints* constraints =
          ...
          peerConnection.vdotokStreamingModule = self;
