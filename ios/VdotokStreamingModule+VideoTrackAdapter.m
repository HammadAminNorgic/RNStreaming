...
@property (weak, nonatomic) VdotokStreamingModule *module;
...
- (instancetype)initWith:(NSNumber*)peerConnectionId
            ...
            vdotokStreamingModule:(VdotokStreamingModule*)module {
    self = [super init];
    if (self) {
...
- (void)addVideoTrackAdapter:(RTCVideoTrack*)track {
    ...
    TrackMuteDetector* muteDetector
        = [[TrackMuteDetector alloc] initWith:self.reactTag
                                      trackId:trackId
                                 vdotokStreamingModule:self.vdotokStreamingModule];
