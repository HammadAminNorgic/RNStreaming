...
@interface VdotokStreamingModule ()
@end

@implementation VdotokStreamingModule
                        ...
                        decoderFactory:(nullable id<RTCVideoDecoderFactory>)decoderFactory
{
  ...
  if (self) {
    ...
    _workerQueue = dispatch_queue_create("VdotokStreamingModule.queue", attributes);
  }
