...
export default class RTCDataChannel extends defineCustomEventTarget(...DATA_CHANNEL_EVENTS) {
    ...
    send(data: string | ArrayBuffer | ArrayBufferView): void {
        if (typeof data === 'string') {
            VdotokStreamingModule.dataChannelSend(this._peerConnectionId, this._reactTag, data, 'text');
        ...
        VdotokStreamingModule.dataChannelSend(this._peerConnectionId, this._reactTag, base64data, 'binary');
    }
    ...
    close(): void {
        ...
        VdotokStreamingModule.dataChannelClose(this._peerConnectionId, this._reactTag);
    }
        ...
        this._subscriptions = [
            EventEmitter.addListener('dataChannelStateChanged', ev => {
                ...
                if (this._readyState === 'open') {
                    ...
                    VdotokStreamingModule.dataChannelDispose(this._peerConnectionId, this._reactTag);
                }
            }),
