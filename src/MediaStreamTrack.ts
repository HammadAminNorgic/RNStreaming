...
class MediaStreamTrack extends defineCustomEventTarget(...MEDIA_STREAM_TRACK_EVENTS) {
    ...
    set enabled(enabled: boolean) {
        ...
        VdotokStreamingModule.mediaStreamTrackSetEnabled(this.id, !this._enabled);
    ...
    stop(): void {
        VdotokStreamingModule.mediaStreamTrackSetEnabled(this.id, false);
    ...
    _switchCamera(): void {
        ...
        VdotokStreamingModule.mediaStreamTrackSwitchCamera(this.id);
    }
    ...
    _setVideoEffect(name:string) {
        ...
        VdotokStreamingModule.mediaStreamTrackSetVideoEffect(this.id, name);
    }
    ...
    release(): void {
        VdotokStreamingModule.mediaStreamTrackRelease(this.id);
    }
}
