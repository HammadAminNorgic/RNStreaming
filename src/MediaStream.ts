...
export default class MediaStream extends defineCustomEventTarget(...MEDIA_STREAM_EVENTS) {
     ...
     * VdotokStreamingModule instance. As the id of a remote MediaStream instance is unique
    ...
    constructor(arg) {
        ...
        this.id = uniqueID();
        // Local MediaStreams are created by VdotokStreamingModule to have their id and
        // reactTag equal because VdotokStreamingModule follows the respective standard's
        ...
        if (typeof arg === 'undefined') {
            VdotokStreamingModule.mediaStreamCreate(this.id);
    ...
    addTrack(track: MediaStreamTrack): void {
        ...
        VdotokStreamingModule.mediaStreamAddTrack(this._reactTag, track.id);
    }
    ...
    removeTrack(track: MediaStreamTrack): void {
        ...
        VdotokStreamingModule.mediaStreamRemoveTrack(this._reactTag, track.id);
    }
    ...
    release(releaseTracks = true): void {
        ...
        VdotokStreamingModule.mediaStreamRelease(this._reactTag);
    }
}
