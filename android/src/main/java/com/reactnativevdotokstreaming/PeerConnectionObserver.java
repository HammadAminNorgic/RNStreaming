...
class PeerConnectionObserver implements PeerConnection.Observer {
    private final static String TAG = VdotokStreamingModule.TAG;
    ...
    PeerConnectionObserver(VdotokStreamingModule vdotokstreamingmodule, int id) {
        ...
        this.videoTrackAdapters = new VideoTrackAdapter(vdotokstreamingmodule, id);
    }
    ...
    WritableMap createDataChannel(String label, ReadableMap config) {
        ...
        DataChannelWrapper dcw = new DataChannelWrapper(vdotokstreamingmodule, id, reactTag, dataChannel);
    ...
    public void onIceCandidate(final IceCandidate candidate) {
        ...
        vdotokstreamingmodule.sendEvent("peerConnectionGotICECandidate", params);
    }
    ...
    public void onIceConnectionChange(PeerConnection.IceConnectionState iceConnectionState) {
        ...
        vdotokstreamingmodule.sendEvent("peerConnectionIceConnectionChanged", params);
    }
    ...
    public void onConnectionChange(PeerConnection.PeerConnectionState peerConnectionState) {
        ...
        vdotokstreamingmodule.sendEvent("peerConnectionStateChanged", params);
    }
    ...
    public void onIceGatheringChange(PeerConnection.IceGatheringState iceGatheringState) {
        ...
        vdotokstreamingmodule.sendEvent("peerConnectionIceGatheringChanged", params);
    }
    ...
    public void onDataChannel(DataChannel dataChannel) {
        ...
        vdotokstreamingmodule.sendEvent("peerConnectionDidOpenDataChannel", params);
    }
    ...
    public void onRenegotiationNeeded() {
        WritableMap params = Arguments.createMap();
        params.putInt("pcId", id);
        vdotokstreamingmodule.sendEvent("peerConnectionOnRenegotiationNeeded", params);
    }
    ...
    public void onSignalingChange(PeerConnection.SignalingState signalingState) {
        ...
        vdotokstreamingmodule.sendEvent("peerConnectionSignalingStateChanged", params);
    }
    ...
    public void onAddTrack(final RtpReceiver receiver, final MediaStream[] mediaStreams) {
        ...
        ThreadUtils.runOnExecutor(() -> {
            ...
            vdotokstreamingmodule.sendEvent("peerConnectionOnTrack", params);
        });
    }
    ...
    public void onRemoveTrack(RtpReceiver receiver){
        ThreadUtils.runOnExecutor(() -> {
            ...
            vdotokstreamingmodule.sendEvent("peerConnectionOnRemoveTrack", params);
        });
    };
