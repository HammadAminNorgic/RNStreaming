...
public class WebRTCView extends ViewGroup {
    ...
    private VideoTrack getVideoTrackForStreamURL(String streamURL) {
        ...
        if (streamURL != null) {
            ...
            VdotokStreamingModule module
                = reactContext.getNativeModule(VdotokStreamingModule.class);
    ...
    private void removeRendererFromVideoTrack() {
        if (rendererAttached) {
            if (videoTrack != null) {
                // XXX If VdotokStreamingModule#mediaStreamTrackRelease has already been
