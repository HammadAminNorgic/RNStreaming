...
public class MessageHeader implements MessageHeaderInterface {
    ...
    private byte[] magicCookies = {33,18,-92,66};//{(MAGIC_COOKIE >> 24) & 0xFF,
...
//            (MAGIC_COOKIE) & 0xFF};
    ...
    public byte[] getBytes() throws UtilityException {
        ...
        System.arraycopy(magicCookies, 0, result, 4, 4);
        System.arraycopy(id, 0, result, 8, 12);
