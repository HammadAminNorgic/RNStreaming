...
public class VdotokStreamingModule extends ReactContextBaseJavaModule {
    static final String TAG = VdotokStreamingModule.class.getCanonicalName();
    ...
    public VdotokStreamingModule(ReactApplicationContext reactContext) {
